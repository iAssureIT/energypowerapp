...
router.patch('/patch/notification_token',UserController.notification_token);
...
router.get('/get/user_details/:user_id',UserController.user_details);

router.get('/get/count/:company_id',UserController.get_count);
