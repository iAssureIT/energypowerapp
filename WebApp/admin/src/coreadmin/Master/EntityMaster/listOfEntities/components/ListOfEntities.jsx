			...
			if (this.state.roles.indexOf("admin") == -1)
				{
					...
					var contactData = a.contactPersons.map((c,i)=>{
						return "<ul><li>#"+(i+1)+"</li><li><b>BranchCode</b>:"+c.branchCode+"</li><li><b>Name</b>:<a title='View profile' target='_blank' href='/employee-profile/'"+c.personID+">"+c.firstName+" "+c.lastName+"</a></li><li><b>Email</b>:"+c.email+"</li></ul>"
					})
			        return{
			        	_id:a._id,
			            companyName:"<b>Company Name : </b>" +"<a  title='View company profile'  target='_blank' href='/company-profile/"+(a.company_Id)+"'>"+a.companyName +" (" +a.companyID+")",
					...
					<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOPadding">
						<section className="content">
							<div className="pageContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								{this.state.entityList && this.state.entityList.length > 0 &&<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 customTab">
