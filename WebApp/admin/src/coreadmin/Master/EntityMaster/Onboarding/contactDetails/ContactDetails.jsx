...
import Department from  '../../../Department/DepartmentMaster-GlobalMaster.js';
import Designation from  '../../../Designation/DesignationMaster-GlobalMaster.js';
...
class ContactDetails extends Component {
	constructor(props) {
		...
		this.state = {
			...
			tableHeading:{
	          ...
	          searchApply     : false,
	          editUrl         : '/appCompany'+'/contact-details/'+this.props.match.params.entityID,
	          deleteMethod    : 'delete',
			...
			const main = async()=>{
				if ($('#ContactDetail').valid()) {
					if(this.state.createUser === true && this.state.listOfEmpID.indexOf(this.state.employeeID) === -1){
						...
						console.log("formValues after create",formValues);
						var formValues1 = {
	...
	updateContact = (formValues)=>{
		console.log("updateContact formvalues",formValues);
								...
								<section className="Content contactSection">
									<div className="row">
										<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											...
											{this.state.contactarray && this.state.contactarray.length > 0 &&<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		                  	...
		                  	<Department  
			                  	...
			                  	editUrl = 	{
			                  					this.props.match.params.entityID && this.props.match.params.contactID ?
			                  				 	'/appCompany/contact-details-modal/'+this.props.match.params.entityID+"/"+this.props.match.params.contactID 
			                  				 	:this.props.match.params.entityID ?
			                  				 	'/appCompany/contact-details-modal/'+this.props.match.params.entityID
			                  				 	:
			                  				 	'/appCompany/contact-details-modal'
			                  				} 
		                  	/>
		                </div>  
		             </div>
