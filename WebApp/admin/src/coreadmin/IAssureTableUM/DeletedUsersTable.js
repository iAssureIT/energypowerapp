	...
	deleteUser(event) {
		...
		.then((response) => {
			if(response.data.message === "USER_DELETED"){
				axios({
					method: "DELETE",
					url: '/api/personmaster/delete/user/'+id,
					headers: headers,
					timeout: 3000,
					data: null,
				})
														...
														}
														{
															this.props.Actioncol ?
																...
																<td className="textAlignCenter">
																	...
																	<div className="modal" id={`${value._id}-rm`} role="dialog">
																		<div className="adminModal adminModal-dialog col-lg-12 col-md-12 col-sm-12 col-xs-12">
																			<div className="modal-content adminModal-content col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1 col-xs-12 noPadding">
																				...
																				<div className="modal-footer adminModal-footer col-lg-12 col-md-12 col-sm-12 col-xs-12">
																					...
																					<div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																						<button type="button" id={value._id} className="btn examDelete-btn col-lg-7 col-lg-offset-5 col-md-7 col-md-offset-5 col-sm-8 col-sm-offset-3 col-xs-10 col-xs-offset-1" data-dismiss="modal" onClick={this.deleteUser.bind(this)} >DELETE</button>
																					</div>
																				</div>
																			</div>
																		</div>
