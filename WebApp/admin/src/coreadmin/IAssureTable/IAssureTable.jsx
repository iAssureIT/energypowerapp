...
class IAssureTable extends Component {
	...
	edit(event) {
		...
		if(this.props.refresh){
			history.push(tableObjects.editUrl + "/" + id);
		}else{
	...
	delete(e) {
		...
		axios({
			...
			// if(tableObjects.listUrl && !this.props.modal){
											...
											return (
												<tr key={i} className="">
													...
													{this.state.tableHeading && this.state.tableHeading.actions ?
														<td className="textAlignCenter" id="ActionContentColumn">
															<span>
																{this.props.tableObjects.editUrl ?
																	...
																	{this.props.editId && this.props.editId === value._id ? null : <i className={"fa fa-trash redFont " + value._id} id={value._id + '-Delete'} onClick={()=>$('.modal-backdrop').remove()} data-toggle="modal" title="Delete" data-target={"#showDeleteModal-" + value._id}></i>}
															</span>
																	...
																	<div className="modal-content adminModal-content col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1 col-xs-12 noPadding">
																		<div className="modal-header adminModal-header col-lg-12 col-md-12 col-sm-12 col-xs-12">
																			<div className="adminCloseCircleDiv pull-right  col-lg-1 col-lg-offset-11 col-md-1 col-md-offset-11 col-sm-1 col-sm-offset-11 col-xs-12 NOpadding-left NOpadding-right">
																				<button type="button" className="adminCloseButton"  id={value._id} onClick={this.closeDeleteModal.bind(this)}>&times;</button>
																			</div>
																		...
																		<div className="modal-footer adminModal-footer col-lg-12 col-md-12 col-sm-12 col-xs-12">
																			<div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																				<button type="button" className="btn adminCancel-btn col-lg-7 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-8 col-sm-offset-1 col-xs-10 col-xs-offset-1" id={value._id} onClick={this.closeDeleteModal.bind(this)}>CANCEL</button>
																			</div>
																			<div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																				<button onClick={this.delete.bind(this)} id={value._id}  type="button" className="btn examDelete-btn col-lg-7 col-lg-offset-5 col-md-7 col-md-offset-5 col-sm-8 col-sm-offset-3 col-xs-10 col-xs-offset-1" >DELETE</button>
																			</div>
																		</div>
																	</div>
																</div>
