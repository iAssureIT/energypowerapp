...
export default class ListOfRecordingLocations extends Component{
  ...
  constructor(props) {
    ...
    this.state = {
           ...
           "tableObjects"  : 
      {
          ...
          searchApply    : false,
          editUrl        : '/recordinglocation',
          listUrl        : '/listrecordingloc'         
      },
 ...
 getRecordingLocCount(){
  ...
  getData(){
    axios.post('/api/recordinglocation/get/list',filterData)
    .then((response)=>{
      var tabledata = response.data.map((a,i)=>{
        return{
          ...
          recorderDetails        : "<div><b>Brand : </b>"+a.brand+"</div>"+"<div><b>Max Channels : </b>"+a.maxchannels+"</div>"+"<div><b>Type : </b>"+a.recorderType+"</div>",
  ...
  showImages(recording_id){
    console.log("recording_id",recording_id);
    // var id = "#showProfile-"+id
    this.setState({recording_id:recording_id},()=>{
      $('myModal').show()
    })
  }
                ...
                <div className="modal col-lg-12 col-md-12 col-sm-12 col-xs-12" id="myModal"  role="dialog">
                    <div className=" modal-dialog adminModal adminModal-dialog">
                      ...
                      <div className="modal-body adminModal-body col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <ShowingModalImages id={this.state.recording_id}/>
                      </div>
                    </div>
                  </div>
               </div>
