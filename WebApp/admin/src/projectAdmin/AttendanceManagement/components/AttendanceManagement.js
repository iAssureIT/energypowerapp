...
const format = "h:mm a";
class AttendanceMnagement extends Component{
   constructor(props) {
      super(props);
      this.state = {
...
setMonthDates(event){
 ...
 handleChange(event){
  ...
  getData(startRange,limitRange){
   var formValues = {
    ...
    axios.get('/api/attendance/get/datewiseUserdetails/'+formValues.monthyear)
    .then((response)=>{
        console.log("response.data",response.data);
        var tableData = response.data.staffAttendance.map((a,i)=>{
          return{
            _id                    : a._id,
          ...
          <section className="content OrgSettingFormWrapper">
           ...
           <div className="row">
              <div className="box-header with-border col-lg-12 col-md-12 col-xs-12 col-sm-12 NOpadding-right">
                  <h4 className="weighttitle col-lg-11 col-md-11 col-xs-11 col-sm-11 NOpadding-right"> Attendance Management</h4>
              </div>
             ...
             <div className="col-lg-offset-1 col-lg-10 col-md-10  col-sm-10 col-xs-10 attendacetable">  
                 <ViewOption
 ...
 export default AttendanceMnagement;