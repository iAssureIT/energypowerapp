...
class ViewOption extends Component {
  ...
  modalClickEvent(){
	...
	handleChange(event){
		...
		this.props.history.push(tableObjects.viewdataurl+date+"/"+id);
										...
										Object.entries(this.state.tableHeading).map( 
											([key, value], i)=> {
													if(key === 'actions'){
														...
														return(
															<th key={i} className="umDynamicHeader srpadd textAlignCenter">{value}
													...
													}
													{
														...
														<td className="textAlignCenter">
														    <span>
									                              ...
									                              <i className="fa  fa-arrow-circle-right tablearrow" title="Edit"  id={this.state.tableData[i].userId} onClick={this.handleChange.bind(this)}></i>
														 	</span>
															
															<div className="modal " id={"showDeleteModal-"+(value._id)} role="dialog">
		                                                        <div className=" adminModal adminModal-dialog modal-lg col-lg-12 col-md-12 col-sm-12 col-xs-12">
