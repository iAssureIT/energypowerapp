...
const format = "h:mm a";
class equipmentSpecification extends Component{
   constructor(props) {
    super(props);
    this.state = {
      "tableHeading": {
          equipmentSpecification: "Equipment Specifications",
          actions: 'Action',
      },
      "tableObjects"  : 
      {
          deleteMethod   : 'delete',
          apiLink        : '/api/equipmentSpecifications/',
          ...
          "fields"       : 
      {
            ...
            attributeName : "equipmentSpecification"
      }
    };
  }
