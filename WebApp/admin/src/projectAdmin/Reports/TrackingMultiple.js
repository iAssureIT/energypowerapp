...
const pathCoordinates = [
    ...
    [
      { lat: 18.4961, lng: 73.8384 },
      { lat: 18.5074, lng: 73.8077 },
      { lat: 18.5314, lng: 73.8446 },
      { lat: 18.5284, lng: 73.8739 }
    ]
];
...
export default class Tracking  extends Component {
  ...
  componentDidMount(){
    ...
    .then(response=>{
      ...
      var routeCoordinates =response.data.routeCoordinates.map(a=>{return{lat:a.latitude,lng:a.longitude}})
