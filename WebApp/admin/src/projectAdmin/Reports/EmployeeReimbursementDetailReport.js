...
const format = "h:mm a";
class EmployeeReimbursementDetailReport extends Component{
   constructor(props) {
      super(props);
      this.state = {
...
setMonthDates(event){
    ...
    .then((response)=>{
        ...
        var tableData = response.data.staffAttendance.map((a,i)=>{
          return{
            ...
            present                : a.present,
            absent                 : a.absent,
            totalDistanceTravelled : a.totalDistanceTravelled ? a.totalDistanceTravelled+"0 Km" : "0 Km",
 ...
 export default EmployeeReimbursementDetailReport;