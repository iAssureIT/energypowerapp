...
export default class ListOfequipmentlocations extends Component{
  constructor(props) {
    super(props);
    this.state = {
      ...
      "tableHeading": {
        ...
        projectLocationName : "Project Location",
      ...
      {
          deleteMethod   : 'delete',
          apiLink        : '/api/equipmentlocation/',
          paginationApply: false,
          searchApply    : false,
          editUrl        : '/equipmentlocation',
          listUrl        : '/listofequipmentloc'
      },
  ...
  getData(){
    axios.post('/api/equipmentlocation/get/list',filterData)
    ...
    .then((response)=>{
      ...
      var tabledata = response.data.map((a,i)=>{
        return{
          _id                    : a._id,
          clientDetails          : a.project_id && a.project_id.client_id ? "<a target='_blank' href="+'/company-profile/'+a.project_id.client_id+">"+(a.project_id.clientName)+"</a>" :"NA",
          projectLocationName    : a.projectLocationName,
          locationName           : "<div class='divWrap'>"+a.locationName+"</div>",
          address                : "<div class='divWrap'>"+a.address[0].addressLine1+"</div>",
          cameraDetails          : "<div><b>Industry : </b>"+a.industry+"</div>"+"<div><b>Actual Performance : </b>"+a.actualPerformance+"</div>"+"<div><b>Equipment Specifications : </b>"+a.equipmentSpecifications+"</div>"+"<div><b>Equipment Model : </b>"+a.equipmentModel+"</div>"+"<div><b>Url : </b>"+a.equipmentUrl+"</div>",
